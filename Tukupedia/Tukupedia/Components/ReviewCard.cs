...
namespace Tukupedia.Components
{
    public class ReviewCard :Card
    {
        ...
        public ReviewCard(double fullWidth)
        {
            ...
            //Init Styles
            tbNamaCust.Style = Application.Current.TryFindResource("textblock-md-success") as Style;
            tbDateCust.FontSize = 12;
            tbUlasan.Style = Application.Current.TryFindResource("textblock-sm") as Style;
